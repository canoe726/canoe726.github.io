  ...
  return (
    ...
    >
      <Flex flex={['2.5', '2.5', '3']} flexDirection='column' padding={['2em 1.2em 2em 1.2em', '2em 1.2em 2em 1.2em', '2em']}>
        ...
        <Text className='summary' marginTop='0.5em' fontSize='md' fontWeight='light' textOverflow='ellipsis' overflow='hidden' color='gray.600'>{file.frontmatter.summary}</Text>
        <Text marginTop='1.5em' fontSize='sm' fontWeight='light' color='gray.400'>{file.frontmatter.date}</Text>
      </Flex>
